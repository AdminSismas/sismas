export const environment = {
  ...
  url: 'https://quimbaya.api.sismas.com.co',
  url_domain_name: 'https://quimbaya.api.sismas.com.co:5001/domain/name?',
  url_viewer: 'https://quimbaya.map.sismas.com.co:8081/mapstore/',
  user_exist: '/username/',
  v2: '/v2',
  validity: 'validity',
  valuation: '/valuation',
