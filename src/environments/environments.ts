export const environment = {
  ...
  contact: '/contact',
  contentRecaptcha : {
    apikey: 'AIzaSyDrQ4wCJiPtzAHds1OJMTJfOgsMuH_Nu2E',
    siteKeyWeb: '6Lf9cjsrAAAAAO_tCXpDf9E-Zir0i8C9oARtQeE5',
    siteKey: '6Lf9cjsrAAAAABl6H871qHQIXfKrKsu1AHWbCeUX',
    urlValidationRecaptcha: 'https://recaptchaenterprise.googleapis.com/v1/projects/localsismadev-1747311497364/assessments?key=',
    consultSite: 'checkout',
    userActionLogin: 'login',
    userRegisterLogin: 'signup',
    userResetPassword: 'password_reset',
  ...
  logo_login: 'assets/img/logo/logo_sismas.png',
