export const environment = {
  ...
  url_domain_name: 'https://country.api.sismas.com.co:5003/domain/name?',
  ...
  validity: 'validity',
  valuation: '/valuation',
  video: 'assets/video/filandia.mp4',
  videoWebm: 'assets/video/filandia.webm',
