export const environment = {
  ...
  url: 'https://montenegro.api.sismas.com.co',
  url_domain_name: 'https://montenegro.api.sismas.com.co:5002/domain/name?',
  url_viewer: 'https://montenegro.map.sismas.com.co:8081/mapstore/',
  user_exist: '/username/',
  v2: '/v2',
  validity: 'validity',
  valuation: '/valuation',
