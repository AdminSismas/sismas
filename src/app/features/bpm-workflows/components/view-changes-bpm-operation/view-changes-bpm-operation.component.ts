...
import { CONSTANT_CHANGE_UNITED_PREDIAL } from '@shared/constants/constantLabels';
import { TABLE_COLUMN_PROPERTIES_ADDRESS_EDITION } from '@shared/constants/constants';
