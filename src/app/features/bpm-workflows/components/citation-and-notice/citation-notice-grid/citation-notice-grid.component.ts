...
import { CitationNoticeCardComponent } from '../citation-notice-card/citation-notice-card.component';
...
import { TypeProcessParticipant } from '@features/bpm-workflows/models/citation-and-notice/info-participants.interface';
