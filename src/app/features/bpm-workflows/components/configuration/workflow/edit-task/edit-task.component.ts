...
import { editTaskInputs } from '@features/bpm-workflows/constants/workflow/edit-task.constants';
import { Preform, Proflow } from '@features/bpm-workflows/models/workflow.model';
