...
import { Sidewalk } from '@shared/models/territorial-organization/sidewalk.model';
import { Neighborhood } from '@shared/models/territorial-organization/neighborhood.model';
import { Commune } from '@shared/models/territorial-organization';
import { Sector } from '@shared/models/territorial-organization/sector.model';
...
import { CharacterValidateService } from '@shared/utils/functions/character-validate.service';
import {
  TerritorialOrganizationService
} from '@shared/services/general/territorial-organization/territorial-organization.service';
import { Zone } from '@shared/models/territorial-organization/zone.model';
import { divideNpn } from '@shared/utils/functions/divide-national-predial-number';
import { Block } from '@shared/models/territorial-organization/block.model';
