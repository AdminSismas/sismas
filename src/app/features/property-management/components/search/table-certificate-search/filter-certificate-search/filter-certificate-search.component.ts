...
import { MODAL_LARGE } from '@shared/constants/constants';
...
import { PaymentValidationComponent } from '@shared/components/payment-validation/payment-validation.component';
import { DataViewCertificate } from '@features/bpm-workflows/models';
