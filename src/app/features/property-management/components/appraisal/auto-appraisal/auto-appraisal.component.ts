...
import { AlfaMainService } from '@features/bpm-workflows/services';import { DynamicFormsComponent } from '@shared/utils/dynamic-forms/dynamic-forms.component';import { JSONInput } from 'src/app/apps/interfaces/forms/dynamic-forms';
