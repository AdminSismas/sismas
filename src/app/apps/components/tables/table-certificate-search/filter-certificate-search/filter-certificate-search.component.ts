...
import {
  ViewCertificateManagementComponent
} from '../../../general-components/view-certificate-management/view-certificate-management.component';
...
@Component({
  ...
  styleUrls: ['./filter-certificate-search.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
...
export class FilterCertificateSearchComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<FilterCertificateSearchComponent>,
  ...
  viewFile(): void {
    ...
    const dialogRef = this.dialog.open(ViewCertificateManagementComponent, {
      ...MODAL_LARGE,
      disableClose: true,
      data: { documentNumber, documentType, fullName, typeCertificate }
    });
