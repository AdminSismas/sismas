...
import { ProcedureStateTableService } from '@features/public-services/services/ticket-office/general-services/procedure-state-table.service';
import {
  ProceduresNames,
  SendRequestProcedureData,
  ViewCertificateManagementData
} from '@features/bpm-workflows/models';
