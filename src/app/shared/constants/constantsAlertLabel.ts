...
export const CONSTANT_ERR_ONLY_TEXT_NUMBER = 'Error, No es permitido caracteres especiales';
export const CONSTANT_ERR_MIN10_CHARACTERS = 'Error, Ingresar minimo 10 caracteres ';
...
export const CONSTANT_ERR_TEXT_ADDRESS_VALIDATOR = 'Error, los caracteres validos son: letras, números, espacios y . , : / ° # - _';
