...
import { RULE_PAGE_CADASTRAL_DA, TITULO_PAGE_CADASTRAL_DA } from '@shared/constants/constants';
import {
  TableCadastralSearchComponent
} from '@features/property-management/components/search/table-cadastral-search/table-cadastral-search.component';
