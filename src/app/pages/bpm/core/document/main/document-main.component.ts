...
import { DocumentsMainTableComponent } from '@features/bpm-workflows/components/documents-main/documents-table/documents-table.component';

@Component({
  selector: 'vex-document-main',
  standalone: true,
  imports: [MatDialogTitle, DocumentsMainTableComponent],
