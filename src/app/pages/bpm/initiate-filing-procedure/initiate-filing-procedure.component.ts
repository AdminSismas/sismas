...
// Custom
import { BasicParticipantTableComponent } from '@features/bpm-workflows/components/initite-filing-procedure/basic-participant-table/basic-participant-table.component';
import { BaunitHead } from '@shared/models';
import { BpmCoreService } from '@features/bpm-workflows/services/core/bpm-core.service';
import { BpmDocument } from '@features/bpm-workflows/models/bpm-document';
...
import { ProcessCardComponent } from '@features/bpm-workflows/components/initite-filing-procedure/process-card/process-card.component';
